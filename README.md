...
Продукує події про лайки на пости/коментарі користувача (до Kafka), про нових підписників тощо.
...
Збирає та оброблює дані про активність користувача і продукує відповідні події в Kafka, наприклад подія log.user-online сповіщатиме сервіси,
асинхронно зв'язані з даним через Kafka про те, що користувач online.
